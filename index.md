  ...
  <div class="hero-content">
    <div class="hero-left">
      <div class="hero-profile">
        <img src="./images/me.jpeg" alt="George Erol Fouché" class="profile-image" fetchpriority="high" width="800" height="800">
      </div>
    </div>
    ...
    <div class="hero-main">
      ...
      <div class="hero-actions">
        <a href="#robotics" class="btn btn-primary"><i data-lucide="rocket" class="lucide-icon"></i> View Projects</a>
        <a href="https://github.com/georgeerol" class="btn btn-outline" target="_blank" rel="noopener noreferrer"><i data-lucide="github" class="lucide-icon"></i> GitHub</a>
        <a href="#contact" class="btn btn-outline"><i data-lucide="mail" class="lucide-icon"></i> Contact</a>
      </div>
    </div>
...
<div id="sliver-pizzeria" class="client-project-subsection sliver-theme">
  ...
  <div class="project-grid">
    ...
    <div class="project-card featured-card">
      <div class="featured-content">
        <div class="client-header">
          <img src="./images/sliver-logo.png" alt="SLIVER Pizzeria Logo" class="client-logo" loading="lazy" decoding="async" width="300" height="300">
        ...
        <div class="project-links">
          <a href="https://sliverpizzeria-web-production.up.railway.app/" class="btn btn-primary" target="_blank" rel="noopener noreferrer"><i data-lucide="rocket" class="lucide-icon"></i> Live Demo</a>
    ...
    <div class="project-card">
      ...
      <div class="project-links">
        <a href="https://sliverpizzeria-web-production.up.railway.app/admin" class="btn btn-primary" target="_blank" rel="noopener noreferrer"><i data-lucide="lock" class="lucide-icon"></i> Admin Panel</a>
        <a href="https://sliverpizzeria-api-production.up.railway.app/docs" class="btn btn-outline" target="_blank" rel="noopener noreferrer"><i data-lucide="book-open" class="lucide-icon"></i> API Docs</a>
      </div>
    </div>
    ...
    <div class="project-card">
      ...
      <div class="demo-item">
        <img src="./images/railway-deploy.png" alt="Railway Deployment - SLIVER Pizzeria Production" class="demo-video project-image" loading="lazy" decoding="async" width="2054" height="1026">
      </div>
      
      <div class="project-links">
        <a href="https://sliverpizzeria-api-production.up.railway.app/" class="btn btn-primary" target="_blank" rel="noopener noreferrer"><i data-lucide="zap" class="lucide-icon"></i> Backend API</a>
      </div>
    </div>
  </div>
  ...
  <div class="client-info-card sliver-info">
    <img src="./images/sliver-mini-logo.png" alt="SLIVER Pizzeria Logo" class="client-logo sliver-logo-img" loading="lazy" decoding="async" width="141" height="141">
...
<div id="vintage-wine" class="client-project-subsection vintage-theme">
  ...
  <div class="project-grid">
    <div class="project-card featured-card vintage-featured">
      <div class="featured-content">
        <div class="client-header">
          <img src="./images/TheBarnyardLogo.png" alt="The Barnyard Wine Bar Logo" class="client-logo" loading="lazy" decoding="async" width="1024" height="1024">
        ...
        <div class="project-links">
          <a href="https://barnyardwinebar.com/" class="btn btn-primary" target="_blank" rel="noopener noreferrer"><i data-lucide="external-link" class="lucide-icon"></i> Live Website</a>
        </div>
      </div>
    ...
    <div class="project-card compact-card">
      ...
      <div class="project-links">
        <a href="https://barnyardwinebar.com/" class="btn btn-primary" target="_blank" rel="noopener noreferrer"><i data-lucide="globe" class="lucide-icon"></i> Visit Site</a>
      </div>
    </div>
    ...
    <div class="project-card compact-card">
      ...
      <div class="project-links">
        <a href="https://barnyardwinebar.com/" class="btn btn-primary" target="_blank" rel="noopener noreferrer"><i data-lucide="users" class="lucide-icon"></i> Join Club</a>
      </div>
    </div>
  </div>
  ...
  <div class="client-info-card vintage-info">
    <img src="./images/TheBarnyardLogo.png" alt="The Barnyard Wine Bar Logo" class="client-logo vintage-logo-img" loading="lazy" decoding="async" width="1024" height="1024">
    <div class="client-details">
...
<section id="robotics" class="projects-section">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <img src="./images/FollowMeGif.gif" alt="Deep Learning Drone Simulator" class="project-image" loading="lazy" decoding="async" width="640" height="334">
    ...
    <div class="project-card">
      ...
      <img src="./images/rover_image.gif" alt="Search And Sample Rover" class="project-image" loading="lazy" decoding="async" width="960" height="540">
    ...
    <div class="project-card">
      ...
      <img src="./images/PR2.gif" alt="Robotic Perception" class="project-image" loading="lazy" decoding="async" width="600" height="319">
    ...
    <div class="project-card">
      ...
      <img src="./images/PickAndDrop.gif" alt="Robotic Arm Pick and Drop" class="project-image" loading="lazy" decoding="async" width="1280" height="720">
    ...
    <div class="project-card">
      ...
      <img src="./images/SelfDrivingCarBehavioralCloning.gif" alt="Self-Driving Car Behavioral Cloning" class="project-image" loading="lazy" decoding="async" width="1000" height="570">
...
<section id="data-pipeline" class="projects-section">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <img src="./images/SystemArchitecture.png" alt="IOT AWS SPARK Architecture" class="project-image" loading="lazy" decoding="async" width="1781" height="833">
    ...
    <div class="project-card">
      ...
      <img src="./images/SparkFlowArchitecture.png" alt="E2E Spark Flow Architecture" class="project-image" loading="lazy" decoding="async" width="1551" height="740">
    ...
    <div class="project-card">
      ...
      <img src="./images/CommercingWithFlinkArchitecture.png" alt="Commercing With Flink Architecture" class="project-image" loading="lazy" decoding="async" width="1485" height="582">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
        <img src="./images/LoginPage.png" alt="Todo App Login" class="project-image" loading="lazy" decoding="async" width="1005" height="695">
        <img src="./images/ToDoPage.png" alt="Todo App Main" class="project-image" loading="lazy" decoding="async" width="1004" height="694">
      </div>
      
      <div class="project-links">
        <a href="https://github.com/georgeerol/ToDoApp" class="btn btn-primary" target="_blank" rel="noopener noreferrer"><i data-lucide="github" class="lucide-icon"></i> View GitHub</a>
      </div>
    </div>
    ...
    <div class="project-card">
      ...
      <img src="./images/ExpensePage.png" alt="Expense Application" class="project-image" loading="lazy" decoding="async" width="2874" height="1438">
    ...
    <div class="project-card">
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 5px;">
        <img src="./images/HomePage.png" alt="PM App Home" class="project-image" loading="lazy" decoding="async" width="2854" height="1536">
        <img src="./images/EmployeesPage.png" alt="PM App Employees" class="project-image" loading="lazy" decoding="async" width="2878" height="1472">
        <img src="./images/ProjectsPage.png" alt="PM App Projects" class="project-image" loading="lazy" decoding="async" width="2870" height="980">
      </div>
      
      <div class="project-links">
        <a href="https://github.com/georgeerol/ProjectManagementApp" class="btn btn-primary" target="_blank" rel="noopener noreferrer"><i data-lucide="github" class="lucide-icon"></i> View GitHub</a>
      </div>
    </div>
  </div>
</section>
...
<section id="mobile" class="projects-section">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <img src="./images/Clima.png" alt="Weather App" class="project-image" loading="lazy" decoding="async" width="2340" height="996">
    ...
    <div class="project-card">
      ...
      <img src="./images/BitcoinTicker.png" alt="Bitcoin Ticker" class="project-image" loading="lazy" decoding="async" width="1408" height="1134">
...
<section id="contact" class="contact-section">
  ...
  <div class="contact-links">
    <a href="https://www.linkedin.com/in/georgefouche/" target="_blank" rel="noopener noreferrer"><i data-lucide="linkedin" class="lucide-icon"></i> LinkedIn</a>
    <a href="https://github.com/georgeerol" target="_blank" rel="noopener noreferrer"><i data-lucide="github" class="lucide-icon"></i> GitHub</a>
  </div>
</section>
