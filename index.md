  ...
  <div class="hero-content">
    <div class="hero-left">
      <div class="hero-profile">
        <img src="./images/me.jpeg" alt="George Erol Fouché" class="profile-image" width="800" height="800" fetchpriority="high">
      </div>
    </div>
...
<div id="sliver-pizzeria" class="client-project-subsection sliver-theme">
  ...
  <div class="project-grid">
    ...
    <div class="project-card featured-card">
      <div class="featured-content">
        <div class="client-header">
          <img src="./images/sliver-logo.png" alt="SLIVER Pizzeria Logo" class="client-logo" width="300" height="300" loading="lazy" decoding="async">
    ...
    <div class="project-card">
      ...
      <div class="demo-item">
        <img src="./images/railway-deploy.png" alt="Railway Deployment - SLIVER Pizzeria Production" class="demo-video project-image" width="2054" height="1026" loading="lazy" decoding="async">
      </div>
  ...
  <div class="client-info-card sliver-info">
    <img src="./images/sliver-mini-logo.png" alt="SLIVER Pizzeria Logo" class="client-logo sliver-logo-img" width="141" height="141" loading="lazy" decoding="async">
...
<div id="vintage-wine" class="client-project-subsection vintage-theme">
  ...
  <div class="project-grid">
    <div class="project-card featured-card vintage-featured">
      <div class="featured-content">
        <div class="client-header">
          <img src="./images/TheBarnyardLogo.png" alt="The Barnyard Wine Bar Logo" class="client-logo" width="1024" height="1024" loading="lazy" decoding="async">
  ...
  <div class="client-info-card vintage-info">
    <img src="./images/TheBarnyardLogo.png" alt="The Barnyard Wine Bar Logo" class="client-logo vintage-logo-img" width="1024" height="1024" loading="lazy" decoding="async">
    <div class="client-details">
...
<section id="robotics" class="projects-section">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <img src="./images/FollowMeGif.gif" alt="Deep Learning Drone Simulator" class="project-image" width="640" height="334" loading="lazy" decoding="async">
    ...
    <div class="project-card">
      ...
      <img src="./images/rover_image.gif" alt="Search And Sample Rover" class="project-image" width="960" height="540" loading="lazy" decoding="async">
    ...
    <div class="project-card">
      ...
      <img src="./images/PR2.gif" alt="Robotic Perception" class="project-image" width="600" height="319" loading="lazy" decoding="async">
    ...
    <div class="project-card">
      ...
      <img src="./images/PickAndDrop.gif" alt="Robotic Arm Pick and Drop" class="project-image" width="1280" height="720" loading="lazy" decoding="async">
    ...
    <div class="project-card">
      ...
      <img src="./images/SelfDrivingCarBehavioralCloning.gif" alt="Self-Driving Car Behavioral Cloning" class="project-image" width="1000" height="570" loading="lazy" decoding="async">
...
<section id="data-pipeline" class="projects-section">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <img src="./images/SystemArchitecture.png" alt="IOT AWS SPARK Architecture" class="project-image" width="1781" height="833" loading="lazy" decoding="async">
    ...
    <div class="project-card">
      ...
      <img src="./images/SparkFlowArchitecture.png" alt="E2E Spark Flow Architecture" class="project-image" width="1551" height="740" loading="lazy" decoding="async">
    ...
    <div class="project-card">
      ...
      <img src="./images/CommercingWithFlinkArchitecture.png" alt="Commercing With Flink Architecture" class="project-image" width="1485" height="582" loading="lazy" decoding="async">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
        <img src="./images/LoginPage.png" alt="Todo App Login" class="project-image" width="1005" height="695" loading="lazy" decoding="async">
        <img src="./images/ToDoPage.png" alt="Todo App Main" class="project-image" width="1004" height="694" loading="lazy" decoding="async">
      </div>
    ...
    <div class="project-card">
      ...
      <img src="./images/ExpensePage.png" alt="Expense Application" class="project-image" width="2874" height="1438" loading="lazy" decoding="async">
    ...
    <div class="project-card">
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 5px;">
        <img src="./images/HomePage.png" alt="PM App Home" class="project-image" width="2854" height="1536" loading="lazy" decoding="async">
        <img src="./images/EmployeesPage.png" alt="PM App Employees" class="project-image" width="2878" height="1472" loading="lazy" decoding="async">
        <img src="./images/ProjectsPage.png" alt="PM App Projects" class="project-image" width="2870" height="980" loading="lazy" decoding="async">
      </div>
...
<section id="mobile" class="projects-section">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <img src="./images/Clima.png" alt="Weather App" class="project-image" width="2340" height="996" loading="lazy" decoding="async">
    ...
    <div class="project-card">
      ...
      <img src="./images/BitcoinTicker.png" alt="Bitcoin Ticker" class="project-image" width="1408" height="1134" loading="lazy" decoding="async">
