...
<div id="sliver-pizzeria" class="client-project-subsection sliver-theme">
  ...
  <div class="project-grid">
    ...
    <div class="project-card featured-card">
      <div class="featured-content">
        <div class="client-header">
          <img src="./images/sliver-logo.png" alt="SLIVER Pizzeria Logo" class="client-logo" loading="lazy">
    ...
    <div class="project-card">
      ...
      <div class="demo-item">
        <img src="./images/railway-deploy.png" alt="Railway Deployment - SLIVER Pizzeria Production" class="demo-video project-image" loading="lazy">
      </div>
  ...
  <div class="client-info-card sliver-info">
    <img src="./images/sliver-mini-logo.png" alt="SLIVER Pizzeria Logo" class="client-logo sliver-logo-img" loading="lazy">
...
<div id="vintage-wine" class="client-project-subsection vintage-theme">
  ...
  <div class="project-grid">
    <div class="project-card featured-card vintage-featured">
      <div class="featured-content">
        <div class="client-header">
          <img src="./images/TheBarnyardLogo.png" alt="The Barnyard Wine Bar Logo" class="client-logo" loading="lazy">
  ...
  <div class="client-info-card vintage-info">
    <img src="./images/TheBarnyardLogo.png" alt="The Barnyard Wine Bar Logo" class="client-logo vintage-logo-img" loading="lazy">
    <div class="client-details">
...
<section id="robotics" class="projects-section">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <img src="./images/FollowMeGif.gif" alt="Deep Learning Drone Simulator" class="project-image" loading="lazy">
    ...
    <div class="project-card">
      ...
      <img src="./images/rover_image.gif" alt="Search And Sample Rover" class="project-image" loading="lazy">
    ...
    <div class="project-card">
      ...
      <img src="./images/PR2.gif" alt="Robotic Perception" class="project-image" loading="lazy">
    ...
    <div class="project-card">
      ...
      <img src="./images/PickAndDrop.gif" alt="Robotic Arm Pick and Drop" class="project-image" loading="lazy">
    ...
    <div class="project-card">
      ...
      <img src="./images/SelfDrivingCarBehavioralCloning.gif" alt="Self-Driving Car Behavioral Cloning" class="project-image" loading="lazy">
...
<section id="data-pipeline" class="projects-section">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <img src="./images/SystemArchitecture.png" alt="IOT AWS SPARK Architecture" class="project-image" loading="lazy">
    ...
    <div class="project-card">
      ...
      <img src="./images/SparkFlowArchitecture.png" alt="E2E Spark Flow Architecture" class="project-image" loading="lazy">
    ...
    <div class="project-card">
      ...
      <img src="./images/CommercingWithFlinkArchitecture.png" alt="Commercing With Flink Architecture" class="project-image" loading="lazy">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
        <img src="./images/LoginPage.png" alt="Todo App Login" class="project-image" loading="lazy">
        <img src="./images/ToDoPage.png" alt="Todo App Main" class="project-image" loading="lazy">
      </div>
    ...
    <div class="project-card">
      ...
      <img src="./images/ExpensePage.png" alt="Expense Application" class="project-image" loading="lazy">
    ...
    <div class="project-card">
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 5px;">
        <img src="./images/HomePage.png" alt="PM App Home" class="project-image" loading="lazy">
        <img src="./images/EmployeesPage.png" alt="PM App Employees" class="project-image" loading="lazy">
        <img src="./images/ProjectsPage.png" alt="PM App Projects" class="project-image" loading="lazy">
      </div>
...
<section id="mobile" class="projects-section">
  ...
  <div class="project-grid">
    <div class="project-card">
      ...
      <img src="./images/Clima.png" alt="Weather App" class="project-image" loading="lazy">
    ...
    <div class="project-card">
      ...
      <img src="./images/BitcoinTicker.png" alt="Bitcoin Ticker" class="project-image" loading="lazy">
